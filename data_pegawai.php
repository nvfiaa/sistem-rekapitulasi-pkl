...
if(isset($_POST['btnsimpan'])) {
    ...
    if ($_GET['hal'] == "edit") {
        ...
        $simpan = mysqli_query($koneksi, "INSERT INTO data_admin (username, password)
...
<div class="container">
    ...
    <div class="card mt-3">
        ...
        <a href="pengguna/laporanpengguna.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cetak Laporan</a>
        <div class="card-body">
